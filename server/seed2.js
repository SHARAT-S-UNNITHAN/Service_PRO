...
// Creates 50 users + 320 providers with real Kerala data
...
// ─────────────────────────────────────────────────────────────
// Kerala Data - Expanded for more variety
// ─────────────────────────────────────────────────────────────
...
const KERALA_REGIONS = {
  "Thiruvananthapuram": ["Kazhakkoottam", "Pattom", "Vanchiyoor", "Kowdiar", "Nemom", "Vattiyoorkavu", "Sreekaryam", "Poojappura", "Neyyattinkara", "Attingal"],
  "Kollam":             ["Kadavoor", "Paravur", "Kottarakkara", "Punalur", "Chavara", "Karunagappally", "Oachira", "Sasthamkotta", "Anchal", "Pathanapuram"],
  "Pathanamthitta":     ["Adoor", "Thiruvalla", "Ranni", "Konni", "Pandalam", "Pathanamthitta", "Mallappally", "Kozhencherry", "Aranmula", "Omallur"],
  "Alappuzha":          ["Cherthala", "Ambalapuzha", "Kuttanad", "Mavelikkara", "Kayamkulam", "Haripad", "Chengannur", "Aroor", "Kalavoor", "Muhamma"],
  "Kottayam":           ["Changanacherry", "Pala", "Ettumanoor", "Vaikom", "Kanjirappally", "Kottayam", "Athirampuzha", "Kumarakom", "Kuravilangad", "Erattupetta"],
  "Idukki":             ["Thodupuzha", "Munnar", "Kattappana", "Devikulam", "Adimali", "Nedumkandam", "Kumily", "Peerumade", "Vandiperiyar", "Rajakkad"],
  "Ernakulam":          ["Aluva", "Angamaly", "Perumbavoor", "Muvattupuzha", "Kothamangalam", "Edappally", "Tripunithura", "Kakkanad", "Mattancherry", "Fort Kochi"],
  "Thrissur":           ["Chalakudy", "Kodungallur", "Kunnamkulam", "Guruvayur", "Irinjalakuda", "Thrissur", "Wadakkanchery", "Chelakkara", "Pazhayannur", "Kechery"],
  "Palakkad":           ["Ottapalam", "Shoranur", "Mannarkkad", "Chittur", "Alathur", "Palakkad", "Kollengode", "Vadakkanchery", "Kuzhalmannam", "Pattambi"],
  "Malappuram":         ["Tirur", "Manjeri", "Perinthalmanna", "Kondotty", "Ponnani", "Malappuram", "Kottakkal", "Nilambur", "Wandoor", "Edappal"],
  "Kozhikode":          ["Vadakara", "Feroke", "Ramanattukara", "Koyilandy", "Quilandy", "Kozhikode", "Mukkam", "Thamarassery", "Koduvally", "Balussery"],
  "Wayanad":            ["Kalpetta", "Mananthavady", "Sulthan Bathery", "Vythiri", "Panamaram", "Meenangadi", "Pulpally", "Thirunelly", "Bathery", "Kaniyambetta"],
  "Kannur":             ["Thalassery", "Iritty", "Payyanur", "Kuthuparamba", "Anthoor", "Kannur", "Mattannur", "Panoor", "Peravoor", "Taliparamba"],
  "Kasaragod":          ["Kanhangad", "Nileshwar", "Bekal", "Cheruvathur", "Manjeshwar", "Kasaragod", "Uppala", "Kumbla", "Mulleria", "Parappa"],
};
...
const MALE_FIRST_NAMES = [
  ...
  "Jerin", "Kevin", "Libin", "Mithun", "Naveen", "Prasad", "Ratheesh",
  "Sandeep", "Tinu", "Umesh", "Vimal", "Akhil", "Binu", "Deepak",
  "Febin", "Gireesh", "Jomon", "Krishna", "Mujeeb", "Nobin", "Pramod"
];
...
const FEMALE_FIRST_NAMES = [
  ...
  "Amitha", "Bindu", "Chandana", "Divya", "Eshitha", "Fathima",
  "Gayathri", "Hridya", "Isha", "Jyothi", "Karthika", "Lakshmi",
  "Maya", "Neethu", "Priya", "Riya", "Sreya", "Teena",
  "Usha", "Varsha", "Yamuna", "Aiswarya", "Catherine", "Evana"
];
...
const LAST_NAMES = [
  ...
  "Mohan", "Rao", "Shetty", "Hegde", "Bhat", "Kurup", "Warrier"
];

const PROFESSIONS = [
  "Plumbing", "Electrical", "Cleaning", "Car Service", "AC Repair",
  "Carpenter", "Gardening", "Painting", "Welding", "Tiling", "Mason", 
  "Pest Control", "Roofing", "Flooring", "Home Appliance Repair", 
  "Furniture Assembly", "Waterproofing", "Gas Stove Repair", 
  "Refrigerator Repair", "Washing Machine Repair", "Mobile Repair", 
  "Laptop Repair", "TV Repair", "Solar Installation", "CCTV Installation",
  "Landscaping", "House Shifting", "Disinfection", "Carpet Cleaning"
];
...
async function seed() {
  ...
  // ── PROVIDERS (320) ──────────────────────────────────────────
  credLines.push("\n\n" + "─".repeat(70));
  credLines.push("  PROVIDERS (320)  —  password for all: Password@123");
  ...
  console.log("\n\n🔧 Seeding 320 providers...");

  for (let i = 1; i <= 320; i++) {
    const fullName   = Math.random() > 0.7 ? makeFullName("female") : makeFullName("male");
    ...
    try {
      ...
      credLines.push(
        `  ${String(i).padEnd(4)} | ${fullName.padEnd(28)} | ${email.padEnd(38)} | ${district.padEnd(15)} | ${professions.join(", ")}`
      );

      if (i % 20 === 0) {
        process.stdout.write(`\r  ✓ ${i}/320 providers created`);
      }
    } catch (err) {
  ...
  console.log(`📊 Total Providers: 320`);
