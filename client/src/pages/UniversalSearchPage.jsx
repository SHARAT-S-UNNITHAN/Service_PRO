// src/pages/UniversalSearchPage.jsx
...
export default function UniversalSearchPage() {
  ...
  const query = decodeURIComponent(rawQ).trim();

  const formatText = (text) => text.replace(/\b\w/g, (c) => c.toUpperCase());
  ...
  return (
    <div className="min-h-screen bg-white py-16 px-6 sm:px-8 lg:px-12 font-sans selection:bg-gray-100">
      <div className="max-w-6xl mx-auto">   {/* Wider container for 16:9 */}

        {/* Heading & Subheading - Left Aligned */}
        <div className="mb-14 text-left">
          <h1 className="text-3xl sm:text-4xl font-semibold text-gray-900 tracking-tight">
            Results for "{formatText(query)}"
          </h1>
